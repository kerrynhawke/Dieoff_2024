...
vp_pattern   = "/pvol/AGCD/v1-0-3/vapourpres_h09/mean/r005/01day/*.nc"
...
periods = {
    "1971_2000": (1971, 1990, f"{output_dir}/mask_monclim_agcd_vpd09_1971_2000.nc"),
    "1995_2024": (1995, 2024, f"{output_dir}/mask_monclim_agcd_vpd09_1995_2024.nc"),
}

all_monthly_means_out = f"{output_dir}/mask_month_means_agcd_vpd09_{start_year}_{end_year}.nc"
