...
# AGCD monthly tmin files
input_pattern = "/pvol/AGCD/v1-0-3/tmin/mean/r005/01month/*.nc"
...
# ---- CLIMATOLOGY PERIODS ----
periods = {
    "1961_1990": (1961, 1990, f"{output_dir}/mask_monclim_agcd_tmin_1961_1990.nc"),
    "1971_2000": (1971, 2000, f"{output_dir}/mask_monclim_agcd_tmin_1971_2000.nc"),
    "1995_2024": (1995, 2024, f"{output_dir}/mask_monclim_agcd_tmin_1995_2024.nc"),
}

# ALL monthly means output
all_monthly_means_out = f"{output_dir}/mask_month_means_agcd_tmin_{start_year}_{end_year}.nc"
