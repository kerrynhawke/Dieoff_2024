...
# AGCD monthly files (ALL YEARS)
input_pattern = "/pvol/AGCD/v1-0-3/precip/total/r005/01month/*.nc"
...
# ---- CLIMATOLOGY PERIODS ----
periods = {
    "1961_1990": (1961, 1990, f"{output_dir}/mask_monclim_agcd_{variable}_1961_1990.nc"),
    "1971_2000": (1971, 2000, f"{output_dir}/mask_monclim_agcd_{variable}_1971_2000.nc"),
    "1995_2024": (1995, 2024, f"{output_dir}/mask_monclim_agcd_{variable}_1995_2024.nc"),
}

# ALL monthly means output
all_monthly_means_out = f"{output_dir}/mask_month_means_agcd_{variable}_{start_year}_{end_year}.nc"
...
print("Interpolating mask to AGCD grid...")
...
masked = ds[variable].where(mask_interp == 1, drop=True)
